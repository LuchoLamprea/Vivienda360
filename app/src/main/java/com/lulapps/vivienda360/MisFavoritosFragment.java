...
public class MisFavoritosFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        limit=0;
        String URL_OBTENER_FAVORITOS="https://udvivienda360.000webhostapp.com/obtener_publicaciones_favoritas_por_correo.php?correo="+convertirCadena(textoCorreo)+"&limit="+limit+"&filtro="+convertirCadena(filtroSQL);
        System.out.println("Luchoooo\tURL: "+URL_OBTENER_FAVORITOS);

        JsonArrayRequest jsonArrayRequest= new JsonArrayRequest(
                Request.Method.GET,
                URL_OBTENER_FAVORITOS,
                null,
                        ...
                        try {
                            ...
                            listAdapter= new ListAdapter(listadoPublicaciones, getContext(), new OnAdapterItemClickListener() {
                                ...
                                public void onAdapterItemClickListener(View v, int position) {
                                    ...
                                    VisualizacionFragment visualizacionFragment= new VisualizacionFragment(listadoPublicaciones.get(position).getId(),"favoritas", "", "");
                                    fragmentTransaction.replace(R.id.contenedor_ppal_favoritos, visualizacionFragment);
            ...
            public void onClick(View v) {
                FiltroFragment filtroFragment= new FiltroFragment(new OnFilterAppliedListener() {
                    ...
                    public void OnFilterAppliedListener(String filtro) {
                        ...
                        String URL_OBTENER_RESULTADOS_FILTRADOS="https://udvivienda360.000webhostapp.com/obtener_publicaciones_favoritas_por_correo.php?correo="+convertirCadena(textoCorreo)+"&limit="+limit+"&filtro="+convertirCadena(filtroSQL);
        ...
        botonAtras.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.navigation_buscar);
                try {
                    onDestroyView();
                    onDestroy();
                    onDetach();
        ...
        cargarMasResultados.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String URL_OBTENER_RESULTADOS_SECUNDARIOS="https://udvivienda360.000webhostapp.com/obtener_publicaciones_favoritas_por_correo.php?correo="+convertirCadena(textoCorreo)+"&limit="+limit+"&filtro="+convertirCadena(filtroSQL);
                                    ...
                                    for(int i=0; i<response.length(); i++){
                                        if(response.getJSONObject(i).getString("barrio").equals("final")){
                                            ...
                                            listadoPublicaciones.add(new ListElement(response.getJSONObject(i).getString("barrio"),
                                                    ...
                                                    response.getJSONObject(i).getString("oferta"), response.getJSONObject(i).getString("inmueble"), "favoritas"));
